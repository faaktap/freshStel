...
<v-btn @click="addNewOne"> Add New One </v-btn>
...
<!--
<hr>
     AnswerModel::: {{ currentRecord.model }}
     <br>
...
<script>
function cl(...args) {console.log('schemaCrud:' ,...args)}
...
export default {
  ...
  methods:{
    ...
    addNewOne() {
     ...
     this.currentRecord.model = {faqOriginator: 'Werner Smit'}
