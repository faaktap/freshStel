<template>
 <v-container>
   <hero-section name="forDB"
              bgpicture="https://www.zmlrekenaars.co.za/test/img/wall117.jpg"
              title="Mass Book Return"
              text=""
              breakup1="100"
              breakup2="20"
               />
      ...
      <v-list dense>
       <v-subheader>Progress
        ...
        <v-list-item v-for="tot in scannedBooksArray" :key="tot.book">
            <v-list-item-content>
                <v-list-item-title>{{ tot.book }}</v-list-item-title><small>
...
export default {
   components: {confirmIt, HeroSection},
   data () {
      return {
      winners:[],
      barcodeid:'',
      ...
      snackTimeout:3000,
      snackColor:"error",
      confirmSound:new Audio('https://www.kuiliesonline.co.za/img/sounds/confirm.mp3'),
      //confirmSound:new Audio('https://kuiliesonline.co.za/api/candid/candidates.php?task=sound&sounddesc=confirm'),
      errorSound:new Audio('https://www.kuiliesonline.co.za/img/sounds/jump.mp3')
    }
   },
   methods: {
     booksScannedSofar() {
