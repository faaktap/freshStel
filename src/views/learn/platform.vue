  ...
  <v-row>
    ...
    <v-col xs-12 lg-8>
        ...
        <v-layout row wrap>
            ...
            <v-flex>
                <v-btn small @click="loadData()"> Refresh </v-btn>
            </v-flex>
            <v-flex>
            ...
            <!--auto-list :subjects="this.getZml.subjects" language="a" @dataEntered="subjectChanged" /-->
        </v-layout>
        <!--/v-window-->
    </v-col>
    </v-row>
...
export default {
    ...
    methods:{
        ...
        loadData() {
           ...
           let ts = {};
           this.contents = []
           ts.sql = 'SELECT * FROM dkhs_lcontent WHERE grade = ' + this.getZml.grade
