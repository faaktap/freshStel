<template>
    ...
    <v-row no-gutters class="mb-6" >
      <v-col cols="12" class="heading-2 text-center"> 
        <v-card class="pa-2"  color="blue" >
            Click on all the columns you wish to export
        </v-card>
      </v-col>
      ...
      -->
      <v-col cols="6" md="3" lg="2"     v-for="n in labels" 
         :key="n.id"          >
         <v-checkbox 
                       v-model="n.clicked"
                       hide-details
  ...
  <v-btn @click="build"> Build </v-btn>
  <v-btn v-if="allowShowMassagedData" @click="view"> View </v-btn>
